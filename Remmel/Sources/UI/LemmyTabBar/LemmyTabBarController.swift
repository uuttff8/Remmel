...
class LemmyTabBarController: UITabBarController {
    ...
    private(set) var createPostOrCommunityCoordinator: CreateMediaCoordinator!
    ...
    func createTabs() {
        ...
        createPostOrCommunityCoordinator = CreateMediaCoordinator(navigationController: nil)
        let createPostOrCommentController = CreateMediaViewController()
...
extension LemmyTabBarController: UITabBarControllerDelegate {
    func tabBarController(
        ...
        if viewController is CreateMediaViewController {
