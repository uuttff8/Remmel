...
open class CommentsViewController: UITableViewController, SwipeTableViewCellDelegate {
     ...
     */
    public func linearizeComments(
        comments: [AbstractComment],
        linearizedComments: inout [AbstractComment],
            ...
            if isCellExpanded(indexPath: indexPath) {
                ...
                _currentlyDisplayed.removeSubrange(
                    Range(uncheckedBounds: (
                            ...
                            upper: selectedIndex + nCellsToDelete + 1
                    ))
                )
    ...
    open func commentsView(
        _ tableView: UITableView,
        isCommentExpandable commentModel: AbstractComment,
        atIndexPath indexPath: IndexPath
    ) -> Bool {
