...
class StyledNavigationController: UINavigationController {
    enum Appearance {
        ...
        static let statusBarColor = UIColor.systemBackground
        static let tintColor = UIColor.lemmyAccent
        static let textColor = UIColor.lemmyAccent
    ...
    /// If view controller conforms to `StyledNavigationControllerPresentable` protocol
    /// then `navigationBarAppearanceOnFirstPresentation`  will be used.
