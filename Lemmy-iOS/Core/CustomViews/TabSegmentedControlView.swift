...
extension TabSegmentedControlView {
    struct Appearance {
        ...
        let buttonTitleColor = UIColor.label

        let bottomBorderColor = Config.Color.separator
        let bottomBorderHeight: CGFloat = 0.5

        let bottomSelectedMarkerColor = UIColor.gray
...
extension TabSegmentedControlView: ProgrammaticallyViewProtocol {
    func setupView() {
