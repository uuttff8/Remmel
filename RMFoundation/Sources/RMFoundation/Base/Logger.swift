...
public enum Logger {
    ...
    //
    public static func logCombineCompletion<T: Error>(
        ...
        switch completion {
        case .finished:
            Self.print(functionName: functionName, fileName: fileName, lineNumber: lineNumber)
        case .failure(let error):
            Self.print(error, functionName: functionName, fileName: fileName, lineNumber: lineNumber)
        }
    }
    ...
    static func print(
        ...
        Swift.print("Completion Error: \(error.localizedDescription), function: \(functionName), file: \(fileName), line: \(lineNumber)")
    }
    ...
    static func print(
        ...
        Swift.print("Complition Finished: function: \(functionName), file: \(fileName), line: \(lineNumber)")
    }
}
